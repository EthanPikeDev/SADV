...
$orderno=$order_data[1];
	...
	$orderno=$order_data[1];
	$fullname=$order_data[2];
	$mobileno=$order_data[3];
	$email=$order_data[4];
	$annuity_rev=$order_data[5];
	$firstname=$order_data[6];
	$lastname=$order_data[7];
	$site_acc_id=$order_data[8];
	$id_number=$order_data[9];
	$bank=$order_data[10];
	$account_number=$order_data[11];
	
	
	
	
	$return=array("response_code"=>2222 ,
		          "response_status"=>true ,
			      "message"=>"Order Created" ,
				  "data"=>array($orderno,$fullname,$mobileno,$email,$annuity_rev,$firstname,$lastname,$site_acc_id,$id_number,$bank,$account_number),
		          );

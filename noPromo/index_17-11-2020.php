		                           ...
		                           <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1485.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-200-200">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1395.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-200-200">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1435.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-200-20">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1295.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-200-20">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1225.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-100-100">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1175.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-100-100">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1145.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-100-10">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1095.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-100-10">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1055.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-50-50">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R985.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-50-50">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R995.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-50-5">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R935.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-50-5">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R915.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-20-20">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R845.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-20-20">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R845.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-20-2">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R795.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-20-2">Select This Plan</button>
				                                <!-- <span>/pm</span> -->
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R755.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-10-10">Select This Plan</button>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R695.00/pm
												<br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-10-10">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R695.00/pm
				                                <br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-10-2">Select This Plan</button>
				                            </div>
				                        </div>
				                    </div>
				                    ...
				                    <div class="single-pricing-table-sg">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R625.00/pm
				                                <br>
												<button class="view-plans-btn btn_plan promo1" data-planval="access-res-unc-red-10-2">Select This Plan</button>
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1495.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-1000-100">Select This Plan</button>
		                           ...
		                           <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1395.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-200-200">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1295.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-200-20">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1225.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-100-100">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1095.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-100-10">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R985.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-50-50">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R935.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-50-5">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R845.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-20-20">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R795.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-20-2">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R695.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-10-10">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R625.00/pm
				                                <br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-access-res-10-2">Select This Plan</button>
				                            </div>
				                        </div>
				                    </div>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1495.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-1000-100">Select This Plan</button>
		                           ...
		                           <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1395.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-200-200">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1295.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-200-20">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1225.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-100-100">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R1095.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-100-10">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R985.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-50-50">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R935.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-50-5">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R845.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-20-20">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R795.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-20-2">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R695.00/pm
												<br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-10-10">Select This Plan</button>
		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <div class="price">
				                                ...
				                                R625.00/pm
				                                <br>
												<button class="view-plans-btn btn_plan adslpromo" data-planval="adsl-ae-access-res-10-2">Select This Plan</button>
				                            </div>
				                        </div>
				                    </div>
...
<!--
						...
						<div class="col-lg-12 col-md-12">
	                        <div class="section-title-form">
	    						...
	    						<select class="form-control" id="sel_product" name="sel_product" disabled>
			    					<option>Click the button to select a product&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</option>
									<!-- vuma gpon start -->
									...
									<!-- vuma gpon end -->
									<!-- vuma ae start -->
									<option value="ae-res-unc-10-2">Fibre Fast Uncapped 10/2 Mbps @ R695</option>
									<option value="ae-res-unc-10-10">Fibre Fast Uncapped 10/10 Mbps @ R755</option>
									<option value="ae-res-unc-20-2">Fibre Fast Uncapped 20/2 Mbps @ R845</option>
									<option value="ae-res-unc-20-20">Fibre Fast Uncapped 20/20 Mbps @ R915</option>
									<option value="ae-res-unc-50-5">Fibre Fast Uncapped 50/5 Mbps @ R995</option>
									<option value="ae-res-unc-50-50">Fibre Fast Uncapped 50/50 Mbps @ R1055</option>
									<option value="ae-res-unc-100-10">Fibre Fast Uncapped 100/10 Mbps @ R1145</option>
									<option value="ae-res-unc-100-100">Fibre Fast Uncapped 100/100 Mbps @ R1225</option>
									<option value="ae-res-unc-200-20">Fibre Fast Uncapped 200/20 Mbps @ R1435</option>
									<option value="ae-res-unc-200-200">Fibre Fast Uncapped 200/200 Mbps @ R1485</option>
									<option value="ae-res-unc-1000-100">Fibre Fast Uncapped 1000/100 Mbps @ R1495</option>
									<!-- vume ae end -->
									<!-- adslpromo products start -->
									<option value="adsl-access-res-10-2">Fibre Fast Uncapped 10/2 Mbps @ R625</option>
									<option value="adsl-access-res-10-10">Fibre Fast Uncapped 10/10 Mbps @ R695</option>
									<option value="adsl-access-res-20-2">Fibre Fast Uncapped 20/2 Mbps @ R795</option>
									<option value="adsl-access-res-20-20">Fibre Fast Uncapped 20/20 Mbps @ R845</option>
									<option value="adsl-access-res-50-5">Fibre Fast Uncapped 50/5 Mbps @ R935</option>
									<option value="adsl-access-res-50-50">Fibre Fast Uncapped 50/50 Mbps @ R985</option>
									<option value="adsl-access-res-100-10">Fibre Fast Uncapped 100/10 Mbps @ R1095</option>
									<option value="adsl-access-res-100-100">Fibre Fast Uncapped 100/100 Mbps @ R1175</option>
									<option value="adsl-access-res-200-20">Fibre Fast Uncapped 200/20 Mbps @ R1295</option>
									<option value="adsl-access-res-200-200">Fibre Fast Uncapped 200/200 Mbps @ R1395</option>
									<option value="adsl-access-res-1000-100">Fibre Fast Uncapped 1000/100 Mbps @ R1495</option>
									<!-- adslpromo products end -->
								</select>
	                    	</div>
                      	</div>						
                        ...
                        <div class="col-4">
                        	<br>
                        	<div class="form-check form-check-inline">
  								<input class="form-check-input" type="radio" name="account_type" id="inlineRadio1" value="Cheque">
  								<label class="form-check-label" for="inlineRadio1">Transmisssion</label>
							</div>
							<div class="form-check form-check-inline">
  								<input class="form-check-input" type="radio" name="account_type" id="inlineRadio2" value="Credit">
  								<label class="form-check-label" for="inlineRadio2">Savings</label>
							</div>
							<div class="form-check form-check-inline">
  								<input class="form-check-input" type="radio" name="account_type" id="inlineRadio2" value="Debit">
...
require([
	...
	function(dom, lang, on, Map, MapView, Locate, FeatureLayer, GraphicsLayer, QueryTask, Query, UniqueValueRenderer, SimpleFillSymbol, Search, Locator, Point, arrayUtils,)
	{
		...
		var map = new Map({
			...
			layers:[Vuma_Gpon_Live_Layer,Vuma_Gpon_Build_Layer,Vuma_AE_Live_Layer,Vuma_AE_Build_Layer, Vuma_AE_ADSL_Layer, Vuma_GPON_ADSL_Layer]

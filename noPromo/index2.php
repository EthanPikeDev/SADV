		                            ...
		                            <div class="single-pricing-table-s">
		                           		<div class="pricing-header">
				                            ...
				                            <ul class="pricing-features-list">
												...
												<li><i class="flaticon-check-mark"></i> Some Fibre providers may not be available in your area</li>
												<li><i class="flaticon-check-mark"></i> Approximately 7-14 days for installation</li>

					 ...
					 $.ajax({
							...
							success:function(data){
								...
								if(response_status){
									...
									var url='https://crm1.sadv.co.za/sadvcrm/NetCash/goto.php?orderno='+orderno+'&fullname='+fullname+'&mobile='+mobile+'&email='+email+'&annuity_rev='+annuity_rev+'&firstname='+firstname+'&lastname='+lastname+'&site_Acc_id='+site_Acc_id;
									if(url!='')
									{
